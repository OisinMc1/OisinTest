...
@section('content')
    ...
    <form action="{{route('todos.update',$todos->id)}}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" id="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title') ? : $todos->title }}" placeholder="Enter Title">
        ...
        <div class="form-group">
            ...
            <textarea name="body" id="body" rows="4" class="form-control {{ $errors->has('body') ? 'is-invalid' : '' }}" placeholder="Enter Todo Description">{{ old('body') ? : $todos->body }}</textarea>
